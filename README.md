...
1. Склонируй репозиторий: `git clone git@github.com:VasilevNStas/ai-agents-encyclopedia.git`
2. Открой папку в **Obsidian**: *Settings → Manage vaults → Open folder as vault*
3. Открой `index.md` — это стартовая точка навигации
4. Переходи по `[[WikiLinks]]` — они ведут к урокам, модулям и между курсами

Всё. Никакой дополнительной настройки не нужно.
